...
public class SchoolApplicationServiceTest {
    ...
    public void testFindAll() {
        ...
        applications.add(new SchoolApplication(1L,"School A", "123-456-7890","admin A","adminA@example.com", 0, 0));
        applications.add(new SchoolApplication(2L, "School B", "987-654-3210", "admin B", "adminB@example.com", 0, 0));
    ...
    public void testFindById() {
        ...
        SchoolApplication application = new SchoolApplication(applicationId, "Test School", "123-456-7890","admin A", "adminA@example.com", 0, 0);
