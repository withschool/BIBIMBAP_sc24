...
import { getCounselInfo, getTeacherListParent, registerCounsel, deleteCounsel, getRequestCounsel, assignCounsel} from '../../service/counsel';
...
const CounselTeacherAssign = () => {
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(setPageTitle('교사 신청 목록'));
    });
    const defaultParams = {
        id: null,
        title: '',
                                    ...
                                    <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                        ...
                                        <div className="p-5">
                                            ...
                                            <div className="d-flex">
                                                <button type="button" className="btn btn-outline-primary ml-5" style={{ display: 'inline-block', width: '120px' }} onClick={() => handleAssign()}>
                                                    승인
                                                </button>
                                                <button type="button" className="btn btn-outline-danger ml-5" style={{ display: 'inline-block', width: '120px' }} onClick={() => handleReject()}>
                                                    반려
                                                </button>
                                            </div>
...
export default CounselTeacherAssign;
