...
export const adminNoticeEdit = async (formData: FormData, noticeId: string): Promise<any> => {
  try {
...
export const classNoticeEdit = async (formData: FormData, noticeId: string): Promise<any> => {
  try {
