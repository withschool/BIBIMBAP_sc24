import{u as x,r,s as f,b as i,j as e,L as N,l as d,v as p,q as u}from"./index-e6579e08.js";import{C as n}from"./Highlight-eedb31b7.js";import{I as w}from"./IconBell-1fdbf761.js";import{I as s}from"./IconCode-1ee24f4a.js";import{I as c}from"./IconHome-8599979b.js";import{I as m}from"./IconPhone-fbd69088.js";import{$ as a}from"./tabs-1aa6e749.js";import"./keyboard-f5d889b5.js";import"./use-resolve-button-type-0cfcefe6.js";import"./use-is-mounted-7d7d3758.js";const $=()=>{const h=x();r.useEffect(()=>{h(f("Tabs"))});const[l,b]=r.useState([]),o=t=>{l.includes(t)?b(v=>v.filter(g=>g!==t)):b([...l,t])};return i("div",{children:[i("ul",{className:"flex space-x-2 rtl:space-x-reverse",children:[e("li",{children:e(N,{to:"/components/tabs",className:"text-primary hover:underline",children:"컴포넌트"})}),e("li",{className:"before:content-['/'] ltr:before:mr-2 rtl:before:ml-2",children:e("span",{children:"탭"})})]}),i("div",{className:"space-y-8 pt-5",children:[i("div",{className:"panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary",children:[e("div",{className:"rounded-full bg-primary p-1.5 text-white ring-2 ring-primary/30 ltr:mr-3 rtl:ml-3",children:e(w,{})}),e("span",{className:"ltr:mr-3 rtl:ml-3",children:"참고 문서: "}),e("a",{href:"https://headlessui.com/react/tabs",target:"_blank",className:"block hover:underline",rel:"noreferrer",children:"https://headlessui.com/react/tabs"})]}),i("div",{className:"grid grid-cols-1 gap-6 lg:grid-cols-2",children:[i("div",{className:"panel",id:"simple",children:[i("div",{className:"mb-5 flex items-center justify-between",children:[e("h5",{className:"text-lg font-semibold dark:text-white-light",children:"Simple Tabs"}),e("button",{type:"button",className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",onClick:()=>o("code1"),children:i("span",{className:"flex items-center",children:[e(s,{className:"me-2"}),"Code"]})})]}),e("div",{className:"mb-5",children:i(a.Group,{children:[i(a.List,{className:"mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]",children:[e(a,{as:r.Fragment,children:({selected:t})=>e("button",{className:`${t?"!border-white-light !border-b-white  text-primary !outline-none dark:!border-[#191e3a] dark:!border-b-black ":""}
